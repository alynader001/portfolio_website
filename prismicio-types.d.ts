...
interface SettingsDocumentData {
  ...
  /**
   * Phone Number Label field in *Settings*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.phone_number_label
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Resume Button field in *Hero → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.resume_button
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  resume_button: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
  ...
  /**
   * Resume Label field in *Hero → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.resume_label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  resume_label: prismic.KeyTextField;
