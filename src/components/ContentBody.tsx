...
export default function ContentBody({ page }: { page: Content.BlogPostDocument | Content.ProjectPageDocument }) {
  ...
  return (
    <Bounded as="article">
      <div className="rounded-2xl border-2 border-slate-800 bg-neutral-50 px-4 py-10 md:px-8 md:py-20">
